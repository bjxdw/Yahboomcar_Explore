...
class scan_compression:
    def __init__(self):
        ...
        self.laserSubTopic = rospy.get_param('~SubTopic', 'scan')
        self.laserPubTopic = rospy.get_param('~PubTopic', 'scan_dilute')
        self.pub = rospy.Publisher(self.laserPubTopic, LaserScan, queue_size=1000)
        self.laserSub = rospy.Subscriber(self.laserSubTopic, LaserScan, self.laserCallback, queue_size=1000)
