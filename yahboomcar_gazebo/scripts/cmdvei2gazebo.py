...
class CmdVel2Gazebo:
    def __init__(self):
        ...
        rospy.Subscriber('/yahboom/cmd_vel', Twist, self.callback, queue_size=1)
        self.pub_steerL = rospy.Publisher('/yahboom/front_left_steering_position_controller/command', Float64, queue_size=1)
        self.pub_steerR = rospy.Publisher('/yahboom/front_right_steering_position_controller/command', Float64, queue_size=1)
        self.pub_rearL = rospy.Publisher('/yahboom/rear_left_velocity_controller/command', Float64, queue_size=1)
        self.pub_rearR = rospy.Publisher('/yahboom/rear_right_velocity_controller/command', Float64, queue_size=1)
